...
7. Currently, when the Google Sheet gets marked as claim submitted, nothing happens.  The sheet needs archving/clearing manually.  Need a Google script added that automatically does this.
